...
assert.ok(labels.some(label => label.distance > 10), 'crowded labels must move away from the point');
...
assert.ok(labels.every(label =>
    label.box.left >= 2 && label.box.right <= 198 &&
    label.box.top >= 2 && label.box.bottom <= 198
));
