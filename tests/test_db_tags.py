...
class TestPublicTagCRUD:
    ...
    def test_create_public_tag(self, db_instance):
    ...
    def test_create_public_tag_duplicate(self, db_instance):
    ...
    def test_get_public_tag_by_name(self, db_instance):
    ...
    def test_get_public_tag_by_name_nonexistent(self, db_instance):
    ...
    def test_get_public_tags(self, db_instance):
...
class TestPrivateTagCRUD:
    ...
    def test_create_private_tag(self, db_instance):
    ...
    def test_create_private_tag_same_name_different_users(self, db_instance):
    ...
    def test_create_private_tag_duplicate_same_user(self, db_instance):
    ...
    def test_get_private_tag_by_name_and_user(self, db_instance):
    ...
    def test_get_private_tag_by_name_and_user_wrong_user(self, db_instance):
    ...
    def test_get_private_tags_for_user(self, db_instance):
    ...
    def test_get_private_tags_empty(self, db_instance):
...
class TestTagGenericOperations:
    ...
    def test_get_tag_public(self, db_instance):
    ...
    def test_get_tag_private(self, db_instance):
    ...
    def test_get_tag_nonexistent(self, db_instance):
...
class TestRecipeTagAssociations:
    ...
    def test_add_public_tag_to_recipe(self, db_instance):
        ...
        tags = db.execute_query(
            "SELECT t.id, t.name FROM tags t JOIN recipe_tags rt ON t.id = rt.tag_id WHERE rt.recipe_id = %s AND t.created_by IS NULL ORDER BY t.name",
            (recipe["id"],),
        )
        assert len(tags) == 1
    ...
    def test_add_public_tag_duplicate(self, db_instance):
    ...
    def test_add_private_tag_to_recipe(self, db_instance):
        ...
        # Verify association exists
        tags = db.execute_query(
            "SELECT t.id, t.name FROM tags t JOIN recipe_tags rt ON t.id = rt.tag_id WHERE rt.recipe_id = %s AND t.created_by = %s ORDER BY t.name",
            (recipe["id"], "user123"),
        )
        assert len(tags) == 1
        assert tags[0]["id"] == tag["id"]
    ...
    def test_add_private_tag_duplicate(self, db_instance):
    ...
    def test_add_recipe_tag_generic_private(self, db_instance):
...
class TestRecipeTagRemoval:
    ...
    def test_remove_public_tag_from_recipe(self, db_instance):
    ...
    def test_remove_private_tag_from_recipe(self, db_instance):
        ...
        # Remove tag
        result = db.remove_private_tag_from_recipe(recipe["id"], tag["id"], "user123")
        assert result is True
...
class TestTagCascadeOperations:
    ...
    def test_recipe_deletion_removes_tag_associations(self, db_instance):
        ...
        assert db.get_private_tag_by_name_and_user("favorites", "user123") is not None


class TestTagConstraints:
    """Test tag constraints and validation"""

    def test_public_tag_name_uniqueness(self, db_instance):
    ...
    def test_private_tag_name_unique_per_user(self, db_instance):
    ...
    def test_recipe_tag_association_uniqueness(self, db_instance):
...
class TestTagEdgeCases:
    ...
    def test_tag_empty_name(self, db_instance):
    ...
    def test_tag_unicode_name(self, db_instance):
    ...
    def test_tag_special_characters(self, db_instance):
...
class TestComplexTagScenarios:
    ...
    def test_recipe_with_mixed_tags(self, db_instance):
        """Test recipe with both public and private tags"""
        db = db_instance

        # Create recipe
        recipe = db.create_recipe({"name": "Complex Recipe", "instructions": "Test"})
    ...
    def test_multiple_users_private_tags_isolation(self, db_instance):
    ...
    def test_tag_operations_performance_many_tags(self, db_instance):
        ...
        public_count = len([tag for tag in result["tags"] if tag["type"] == "public"])
        private_count = len([tag for tag in result["tags"] if tag["type"] == "private"])
