...
class TestRatingSearch:
    ...
    async def test_search_recipes_by_min_rating(self, test_client_with_data):
        client, app = test_client_with_data
        """Test searching recipes with minimum rating filter"""

        # Test with a moderate minimum rating
        min_rating = 3.0
        response = await client.get(f"/recipes/search?min_rating={min_rating}")
    ...
    async def test_search_recipes_by_max_rating(self, test_client_with_data):
        client, app = test_client_with_data
        """Test searching recipes with maximum rating filter"""

        # Test with a moderate maximum rating
        max_rating = 4.0
        response = await client.get(f"/recipes/search?max_rating={max_rating}")
    ...
    async def test_search_recipes_by_rating_range(self, test_client_with_data):
        client, app = test_client_with_data
    ...
    async def test_search_recipes_high_min_rating(self, test_client_with_data):
        client, app = test_client_with_data
    ...
    async def test_search_recipes_low_max_rating(self, test_client_with_data):
        client, app = test_client_with_data
    ...
    async def test_search_recipes_invalid_rating_range(self, test_client_with_data):
        client, app = test_client_with_data
    ...
    async def test_search_recipes_rating_boundary_values(self, test_client_with_data):
        """Test searching with rating boundary values (0, 5)"""
        client, app = test_client_with_data

        # Test minimum possible rating
        response = await client.get("/recipes/search?min_rating=0")
        assert response.status_code == 200
        data = response.json()
        assert "recipes" in data

        # Test maximum possible rating
        response = await client.get("/recipes/search?max_rating=5")
        assert response.status_code == 200
        data = response.json()
        assert "recipes" in data

        # Test exact boundary values
        response = await client.get("/recipes/search?min_rating=0&max_rating=5")
        assert response.status_code == 200
        data = response.json()
        assert "recipes" in data

    async def test_search_recipes_negative_rating(self, test_client_with_data):
        client, app = test_client_with_data
        """Test searching with negative rating values"""

        # Negative ratings should be handled gracefully
        response = await client.get("/recipes/search?min_rating=-1")
    ...
    async def test_search_recipes_rating_above_five(self, test_client_with_data):
        client, app = test_client_with_data
        """Test searching with rating values above 5"""

        # Ratings above 5 should be handled gracefully
        response = await client.get("/recipes/search?min_rating=6")
    ...
    async def test_search_recipes_decimal_ratings(self, test_client_with_data):
        client, app = test_client_with_data
        ...
        for rating in decimal_ratings:
            response = await client.get(f"/recipes/search?min_rating={rating}")
            assert response.status_code == 200
            data = response.json()
    ...
    async def test_search_recipes_rating_with_no_ratings(self, test_client_with_data):
    ...
    async def test_search_recipes_string_rating_values(self, test_client_with_data):
        client, app = test_client_with_data
        """Test searching with string rating values"""

        # Non-numeric rating values should be handled gracefully
        response = await client.get("/recipes/search?min_rating=abc")
    ...
    async def test_search_recipes_rating_filter_vs_no_filter(self, test_client_with_data):
        ...
        high_rating_response = await client.get("/recipes/search?min_rating=4.0")
    ...
    async def test_search_recipes_multiple_rating_parameters(self, test_client_with_data):
        ...
        response = await client.get("/recipes/search?min_rating=3.0&min_rating=4.0")
    ...
    async def test_search_recipes_rating_precision(self, test_client_with_data):
        client, app = test_client_with_data
        """Test rating search with high precision decimal values"""

        # Test with many decimal places
        precise_rating = 3.14159
        response = await client.get(f"/recipes/search?min_rating={precise_rating}")
    ...
    async def test_search_recipes_zero_rating(self, test_client_with_data):
        client, app = test_client_with_data
        """Test searching for recipes with exactly zero rating"""

        response = await client.get("/recipes/search?min_rating=0&max_rating=0")
