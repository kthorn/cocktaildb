...
class TestSearchIngredientHierarchy:
    ...
    def test_search_returns_full_name_for_root_ingredient(self, db_instance):
    ...
    def test_search_returns_hierarchy_for_root_ingredient(self, db_instance):
    ...
    def test_search_returns_full_name_for_nested_ingredient(self, db_instance):
    ...
    def test_search_returns_hierarchy_array_for_nested_ingredient(self, db_instance):
    ...
    def test_search_empty_results_does_not_crash(self, db_instance):
    ...
    def test_search_with_ingredient_filter_includes_hierarchy(self, db_instance):
    ...
    def test_search_with_user_context_includes_hierarchy(self, db_instance):
