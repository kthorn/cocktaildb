...
class TestExtractAllIngredientIds:
    ...
    def test_extract_ids_single_ingredient_root_level(self):
        ...
        ingredients_list = [{"ingredient_id": 5, "ingredient_path": "/5/"}]
    ...
    def test_extract_ids_single_ingredient_with_hierarchy(self):
        ...
        ingredients_list = [{"ingredient_id": 10, "ingredient_path": "/1/5/10/"}]
    ...
    def test_extract_ids_multiple_ingredients_no_overlap(self):
        ...
        ingredients_list = [
            {"ingredient_id": 5, "ingredient_path": "/1/5/"},
            {"ingredient_id": 8, "ingredient_path": "/2/8/"},
        ]
    ...
    def test_extract_ids_multiple_ingredients_with_overlap(self):
        ...
        ingredients_list = [
            {"ingredient_id": 10, "ingredient_path": "/1/5/10/"},
            {"ingredient_id": 11, "ingredient_path": "/1/5/11/"},
            {"ingredient_id": 12, "ingredient_path": "/1/12/"},
        ]
    ...
    def test_extract_ids_deep_hierarchy(self):
        ...
        ingredients_list = [{"ingredient_id": 20, "ingredient_path": "/1/3/7/15/20/"}]
    ...
    def test_extract_ids_none_values(self):
        ...
        ingredients_list = [{"ingredient_id": None, "ingredient_path": None}]
    ...
    def test_extract_ids_malformed_path(self):
        ...
        ingredients_list = [{"ingredient_id": 5, "ingredient_path": "malformed/path"}]
    ...
    def test_extract_ids_path_with_non_numeric_parts(self):
        ...
        ingredients_list = [{"ingredient_id": 5, "ingredient_path": "/1/abc/5/"}]
...
class TestAssembleIngredientFullNames:
    ...
    def test_assemble_full_names_single_ingredient_root(self):
        ...
        ingredients_list = [
            {"ingredient_id": 5, "ingredient_name": "Gin", "ingredient_path": "/5/"}
        ]
    ...
    def test_assemble_full_names_two_level_hierarchy(self):
        ...
        ingredient_names_map = {5: "Gin", 10: "London Dry Gin"}
    ...
    def test_assemble_full_names_deep_hierarchy(self):
        ...
        assert (
            ingredients_list[0]["full_name"]
            == "Bombay Sapphire [London Dry Gin;Gin;Spirits]"
        )
        # Hierarchy should be root to leaf order
        assert ingredients_list[0]["hierarchy"] == [
            "Spirits",
            "Gin",
            "London Dry Gin",
            "Bombay Sapphire",
    ...
    def test_assemble_full_names_missing_names_in_map(self):
        ...
        assert (
            ingredients_list[0]["full_name"]
            == "Bombay Sapphire [London Dry Gin;Spirits]"
        )
    ...
    def test_assemble_full_names_unicode_names(self):
        ...
        ingredient_names_map = {5: "Spirits", 10: "Liqueurs 🍸", 20: "Café Liqueur"}
    ...
    def test_assemble_full_names_special_characters(self):
        ...
        assert (
            ingredients_list[0]["full_name"]
            == 'St-Germain\'s "Premium" & Elderflower [Liqueurs & Cordials]'
        )
...
class TestUtilsIntegration:
    ...
    def test_utils_performance_with_many_ingredients(self):
        ...
        for ingredient in recipe_ingredients:
            ...
            assert (
                "[" in ingredient["full_name"]
                or ingredient["full_name"] == ingredient["ingredient_name"]
            )  # Should have hierarchy separator or be root level
