...
class RecipeResponse(BaseModel):
    ...
    created_by: Optional[str] = Field(None, description="User ID who created the recipe")
...
class RatingResponse(BaseModel):
    ...
    created_at: Optional[datetime] = Field(None, description="When the rating was created")
...
class RatingSummaryResponse(BaseModel):
    ...
    user_rating: Optional[RatingResponse] = Field(None, description="Current user's rating (if authenticated)")
